...
.. testcode::
    ...
    class MyProblem:
        ...
        def get_box_variables(self) -> alpaqa.Box: ...
        def get_box_general_constraints(self) -> alpaqa.Box: ...
        def check(self): ...
...
.. note::
    ...
    .. code-block:: python
        ...
        def eval_objective_gradient(self, x: np.ndarray, grad_f: np.ndarray) -> None:
            grad_f[:] = A @ x - b
