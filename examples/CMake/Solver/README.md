...
```sh
git clone https://github.com/kul-optec/alpaqa --branch=1.1.0a2 --single-branch
conan export alpaqa
```
...
[CMake API Reference](https://kul-optec.github.io/alpaqa/1.1.0a2/Sphinx/reference/cmake-api.html) page.
