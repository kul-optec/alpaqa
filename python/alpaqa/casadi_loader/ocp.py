...
from ..casadi_generator import (
    generate_casadi_control_problem,
    write_casadi_control_problem_data,
)
...
def _load_casadi_control_problem(sofile, N):
    ...
    return pa.load_casadi_control_problem(sofile, N=N)
...
def generate_and_compile_casadi_control_problem(
    ...
    **kwargs,
    ...
    key = base64.b64encode(pickle.dumps((f, l, l_N, h, h_N, c, c_N, name, kwargs))).decode("ascii")
