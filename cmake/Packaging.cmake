...
if (ALPAQA_WITH_DL)
    list(APPEND CPACK_COMPONENTS_ALL "dl_loader" "dl_loader_dev")
endif()
if (ALPAQA_WITH_CASADI)
    list(APPEND CPACK_COMPONENTS_ALL "casadi" "casadi_dev")
endif()
if (ALPAQA_WITH_CUTEST)
    list(APPEND CPACK_COMPONENTS_ALL "cutest" "cutest_dev")
endif()
...
set(CPACK_DEBIAN_DL_LOADER_PACKAGE_NAME "libalpaqa-dl-loader")
set(CPACK_DEBIAN_DL_LOADER_DISPLAY_NAME "alpaqa dynamic problem loader")
set(CPACK_DEBIAN_DL_LOADER_DESCRIPTION "Shared library for loading dynamically compiled problem modules in alpaqa.")
set(CPACK_DEBIAN_DL_LOADER_GROUP "Runtime")
set(CPACK_DEBIAN_DL_LOADER_PACKAGE_DEPENDS "libalpaqa (= ${CPACK_PACKAGE_VERSION})")
set(CPACK_COMPONENT_DL_LOADER_DEPENDS "lib")

set(CPACK_DEBIAN_DL_LOADER_DEV_PACKAGE_NAME "libalpaqa-dl-loader-dev")
set(CPACK_DEBIAN_DL_LOADER_DEV_DISPLAY_NAME "alpaqa dynamic problem loader development files")
set(CPACK_DEBIAN_DL_LOADER_DEV_DESCRIPTION "C++ headers and CMake target files for the alpaqa dynamic problem loader library.")
set(CPACK_DEBIAN_DL_LOADER_DEV_GROUP "Development")
set(CPACK_DEBIAN_DL_LOADER_DEV_PACKAGE_DEPENDS "libalpaqa-dl-loader (= ${CPACK_PACKAGE_VERSION}), libalpaqa-dev (= ${CPACK_PACKAGE_VERSION}), libalpaqa-dl-dev (= ${CPACK_PACKAGE_VERSION})")
set(CPACK_COMPONENT_DL_LOADER_DEV_DEPENDS "dl_loader;dev;dl_dev")

set(CPACK_DEBIAN_CUTEST_PACKAGE_NAME "libalpaqa-cutest")
set(CPACK_DEBIAN_CUTEST_DISPLAY_NAME "alpaqa CUTEst interface")
set(CPACK_DEBIAN_CUTEST_DESCRIPTION "Shared library interface for loading and solving CUTEst problems with alpaqa.")
set(CPACK_DEBIAN_CUTEST_GROUP "Runtime")
set(CPACK_DEBIAN_CUTEST_PACKAGE_DEPENDS "libalpaqa (= ${CPACK_PACKAGE_VERSION})")
set(CPACK_COMPONENT_CUTEST_DEPENDS "lib")

set(CPACK_DEBIAN_CUTEST_DEV_PACKAGE_NAME "libalpaqa-cutest-dev")
set(CPACK_DEBIAN_CUTEST_DEV_DISPLAY_NAME "alpaqa CUTEst interface development files")
set(CPACK_DEBIAN_CUTEST_DEV_DESCRIPTION "C++ headers and CMake target files for the alpaqa CUTEst interface library.")
set(CPACK_DEBIAN_CUTEST_DEV_GROUP "Development")
set(CPACK_DEBIAN_CUTEST_DEV_PACKAGE_DEPENDS "libalpaqa-cutest (= ${CPACK_PACKAGE_VERSION}), libalpaqa-dev (= ${CPACK_PACKAGE_VERSION})")
set(CPACK_COMPONENT_CUTEST_DEV_DEPENDS "cutest;dev")
...
if (ALPAQA_WITH_DL)
    string(APPEND CPACK_DEBIAN_BIN_PACKAGE_DEPENDS ", libalpaqa-dl-loader (= ${CPACK_PACKAGE_VERSION})")
    list(APPEND CPACK_COMPONENT_BIN_DEPENDS "dl_loader")
endif()
if (ALPAQA_WITH_CASADI)
...
if (ALPAQA_WITH_CUTEST)
    string(APPEND CPACK_DEBIAN_BIN_PACKAGE_DEPENDS ", libalpaqa-cutest (= ${CPACK_PACKAGE_VERSION})")
    list(APPEND CPACK_COMPONENT_BIN_DEPENDS "cutest")
endif()
...
if (ALPAQA_WITH_DL)
    string(APPEND CPACK_DEBIAN_EXTRA_PACKAGE_DEPENDS ", libalpaqa-dl-loader (= ${CPACK_PACKAGE_VERSION})")
    list(APPEND CPACK_COMPONENT_EXTRA_DEPENDS "dl_loader")
endif()
if (ALPAQA_WITH_CUTEST)
    string(APPEND CPACK_DEBIAN_EXTRA_PACKAGE_DEPENDS ", libalpaqa-cutest (= ${CPACK_PACKAGE_VERSION})")
    list(APPEND CPACK_COMPONENT_EXTRA_DEPENDS "cutest")
endif()
...
if (ALPAQA_WITH_DL)
    string(APPEND CPACK_DEBIAN_EXTRA_DEV_PACKAGE_DEPENDS ", libalpaqa-dl-loader-dev (= ${CPACK_PACKAGE_VERSION})")
    list(APPEND CPACK_COMPONENT_EXTRA_DEV_DEPENDS "dl_loader_dev")
endif()
if (ALPAQA_WITH_CUTEST)
    string(APPEND CPACK_DEBIAN_EXTRA_DEV_PACKAGE_DEPENDS ", libalpaqa-cutest-dev (= ${CPACK_PACKAGE_VERSION})")
    list(APPEND CPACK_COMPONENT_EXTRA_DEV_DEPENDS "cutest_dev")
endif()
