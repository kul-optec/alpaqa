...
void register_pantr(py::module_ &m) {
    ...
    py::class_<PANTRProgressInfo>(m, "PANTRProgressInfo",
        ...
        .def_readonly("y_hat", &PANTRProgressInfo::ŷ, "Candidate updated multipliers at x̂ :math:`\\hat y(\\hat x)`")
        ...
        .def_readonly("τ", &PANTRProgressInfo::τ, "Acceptance (1) or rejection (0) of previous accelerated step :math:`\\tau`")
