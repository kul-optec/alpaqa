...
ALPAQA_IF_FLOAT(template void register_ocp<alpaqa::EigenConfigf>(py::module_ &);)
ALPAQA_IF_LONGD(template void register_ocp<alpaqa::EigenConfigl>(py::module_ &);)
ALPAQA_IF_QUADF(template void register_ocp<alpaqa::EigenConfigq>(py::module_ &);)
